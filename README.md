...
Tambahan di luar roadmap awal `PLAN.md`, ditambahkan atas permintaan setelah fase 1-7 selesai: **dukungan offline-first**, **mode tamu tanpa akun** (lihat bagian [Offline](#offline) di atas), dan **Article** — artikel literasi keuangan harian ("dari mana duit datang / cara duit bekerja") yang ditulis otomatis tiap pagi berdasarkan riset internet nyata (lihat [`backend/README.md`](./backend/README.md#article-literasi-keuangan-harian)), lengkap dengan sumber referensi, tersimpan di PostgreSQL, dan bisa dibaca/ditandai favorit dari web maupun mobile.
